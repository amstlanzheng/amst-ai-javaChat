...
INSERT INTO `course_reservation` (`id`, `course`, `student_name`, `contact_info`, `school`, `remark`) VALUES
    (1, '新媒体运营', '张三', '13899762348', '广东校区', '安排一个好点的老师'),
    (2, 'UI设计', '李四', '13899762348', '上海校区', '差不多的老师'),
    (3, 'AI人工智能', '王五', '13899762348', '西安校区', '最便宜的老师'),
    (4, 'Python大数据开发', '赵六', '13899762348', '西安校区', '最想进步的老师');
