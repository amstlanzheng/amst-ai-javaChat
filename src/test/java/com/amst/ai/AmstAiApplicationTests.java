...
class AmstAiApplicationTests {
    ...
    public void testEmbedding() {
        //创建pdf读取器
        // 读取pdf
        ParagraphPdfDocumentReader pdfReader = new ParagraphPdfDocumentReader("classpath:/pdf/Java面试题必知必会-V2版.pdf",
        ...
        SearchRequest build = SearchRequest.builder()
                .query("varchar(10) 和 varchar(20) 的区别？")
                .topK(1)
